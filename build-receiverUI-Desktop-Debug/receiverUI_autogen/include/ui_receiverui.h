...
public:
    ...
    void setupUi(QMainWindow *ReceiverUI)
    {
        ...
        rangeTextEdit->setReadOnly(true);
        ...
        beforeTextEdit->setReadOnly(true);
        ...
        afterTextEdit->setReadOnly(true);
        ...
        spinBoxTransposeID->setMaximum(999999999);
